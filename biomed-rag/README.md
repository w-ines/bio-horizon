...
├── api/                 # Routes & schemas
├── deepagents/          # LangGraph agent, tools, memory
├── ner/                 # NER backends (PubTator3, OpenMed, GLiNER2, PubMedBERT)
├── kg/                  # Knowledge Graph build/query/store
├── rag/                 # Vector store, retriever, RAG chain
├── core_tools/          # PubMed, KG, NER, job tools
├── jobs/                # Async ingestion jobs
├── scheduler/           # Scheduled tasks
├── services/            # Topic & user services
